        ...
        <div className="profile">
            ...
            <div className="details">
                <div className='detaildiv'>   
                    <b>Name: </b><span>{profile?profile.user.name:"loading"}</span>
                </div>
                <div className='detaildiv'>    
                    <b>UserName: </b><span>Rock</span>
                </div>
                <div className='detaildiv'>    
                    <b>Email: </b><span>{profile?profile.user.email:"loading"}</span>
                </div>
            </div>
            <div className='infos'>
                ...
                <span className='infobox'>
                    <span className='infotitle'>Posts</span><span>{profile.posts.length}</span>
                </span>
            </div>
        </div>
        <a className="waves-effect waves-light pink btn" id='follow' onClick={()=>Follow()}>follow</a>
